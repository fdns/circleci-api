...
/// UpdateScheduleParametersTimetable : Timetable that specifies when a schedule triggers.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateScheduleParametersTimetable {
    /// Number of times a schedule triggers per hour, value must be between 1 and 60
    #[serde(rename = "per-hour", skip_serializing_if = "Option::is_none")]
    pub per_hour: Option<i32>,
    /// Hours in a day in which the schedule triggers.
    #[serde(rename = "hours-of-day", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "days-of-month", skip_serializing_if = "Option::is_none")]
...
impl UpdateScheduleParametersTimetable {
    /// Timetable that specifies when a schedule triggers.
    pub fn new() -> UpdateScheduleParametersTimetable {
